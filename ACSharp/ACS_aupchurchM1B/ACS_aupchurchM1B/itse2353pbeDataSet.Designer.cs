...
namespace ACS_aupchurchM1B.itse2353pbeDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [aupchurchSU252353].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [aupchurchSU252353].[Customers] ([CustomerID], [CompanyName], [ContactName], [ContactTitle]) VALUES (@CustomerID, @CompanyName, @ContactName, @ContactTitle);
SELECT CustomerID, CompanyName, ContactName, ContactTitle FROM aupchurchSU252353.Customers WHERE (CustomerID = @CustomerID)";
...
SELECT CustomerID, CompanyName, ContactName, ContactTitle FROM aupchurchSU252353.Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ACS_aupchurchM1B.Properties.Settings.Default.SQLCUSTOMERSConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, CompanyName, ContactName, ContactTitle FROM aupchurchSU252353." +
                "Customers";
        ...
        public virtual int Fill(itse2353pbeDataSet.CustomersDataTable dataTable) {
        ...
        public virtual itse2353pbeDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            itse2353pbeDataSet.CustomersDataTable dataTable = new itse2353pbeDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(itse2353pbeDataSet.CustomersDataTable dataTable) {
